...
const domains = [
  { title: 'Médecine Générale', icon: Stethoscope, image: 'https://images.unsplash.com/photo-1559839734-2b71f1536783?auto=format&fit=crop&q=80&w=600' },
  { title: 'Cardiologie', icon: HeartPulse, image: 'https://images.unsplash.com/photo-162859535482e-4370c47afc24?auto=format&fit=crop&q=80&w=600' },
  { title: 'Pédiatrie', icon: Baby, image: 'https://images.unsplash.com/photo-1623944889288-cd147dbb517c?auto=format&fit=crop&q=80&w=600' },
  { title: 'Dermatologie', icon: Dna, image: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&q=80&w=600' },
];
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="md:w-2/5 relative h-64 md:h-auto">
                  <img src="https://images.unsplash.com/photo-1576091160550-217359f4ecf8?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="mt-auto h-48 overflow-hidden rounded-b-3xl">
                  <img src="https://images.unsplash.com/photo-1579154234431-da0c3668e219?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover grayscale opacity-80" referrerPolicy="no-referrer" />
                </div>
              </motion.div>
